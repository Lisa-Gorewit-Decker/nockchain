...
pub use terminal::{
    ...
    TerminalOraclePrefixProof, TerminalPrimitiveConstraintOpening,
    TerminalPrimitiveConstraintProof, TerminalProductionProof, TerminalProofBodyDigest,
    TerminalProofKind, TerminalProofParameters, TerminalProofPrelude, TerminalPublicValuesDigest,
    TerminalQueryPlan, TerminalR1csRowProductRound, TerminalR1csRowProductSumcheckProof,
