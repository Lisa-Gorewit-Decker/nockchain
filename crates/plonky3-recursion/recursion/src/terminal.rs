...
impl NativeTerminalCompiler {
        ...
        F: Field + BasedVectorSpace<Goldilocks>,
    {
        ...
        if proof.profile != expected_profile {
            return Err(
                NativeTerminalVerifyError::TerminalNpoPolynomialColumnLengthMismatch {
                    label: "npo_polynomial_fri_profile".into(),
    ...
    fn npo_polynomial_combined_column_oracle_label() -> &'static str {
        "npo_polynomial_column/combined"
    }

    fn npo_polynomial_combined_column_fold_oracle_label(round: usize) -> String {
        format!("npo_polynomial_column_combined_fold/{round}")
    }

    fn npo_polynomial_combined_residual_oracle_label() -> &'static str {
        "npo_polynomial_residual/combined"
    }

    fn npo_polynomial_combined_residual_fold_oracle_label(round: usize) -> String {
        format!("npo_polynomial_residual_combined_fold/{round}")
    }
    ...
    fn derive_terminal_npo_polynomial_column_combination_challenge<F>(
        prelude: &TerminalProofPrelude,
        column_commitments: &[TerminalOracleCommitment],
    ) -> Result<F, NativeTerminalVerifyError>
    where
        F: BasedVectorSpace<Goldilocks>,
    {
        ...
        while basis.len() < expected {
            ...
            let block = Self::terminal_npo_polynomial_column_combination_challenge_block(
                prelude,
                column_commitments,
                counter,
            );
    ...
    fn derive_terminal_npo_polynomial_combined_fold_challenge<F>(
        prelude: &TerminalProofPrelude,
        column_commitments: &[TerminalOracleCommitment],
        combined_commitment: &TerminalOracleCommitment,
        fold_commitments: &[TerminalOracleCommitment],
        ...
        F: BasedVectorSpace<Goldilocks>,
    {
        ...
        while basis.len() < expected {
            ...
            let block = Self::terminal_npo_polynomial_combined_fold_challenge_block(
                prelude,
                column_commitments,
                combined_commitment,
                fold_commitments,
    ...
    fn derive_terminal_npo_polynomial_residual_combination_challenge<F>(
        prelude: &TerminalProofPrelude,
        column_commitments: &[TerminalOracleCommitment],
    ) -> Result<F, NativeTerminalVerifyError>
    where
        F: BasedVectorSpace<Goldilocks>,
    {
        ...
        while basis.len() < expected {
            ...
            let block = Self::terminal_npo_polynomial_residual_combination_challenge_block(
                prelude,
                column_commitments,
                counter,
            );
    ...
    fn derive_terminal_npo_polynomial_residual_fold_challenge<F>(
        prelude: &TerminalProofPrelude,
        column_commitments: &[TerminalOracleCommitment],
        combined_residual_commitment: &TerminalOracleCommitment,
        fold_commitments: &[TerminalOracleCommitment],
        ...
        F: BasedVectorSpace<Goldilocks>,
    {
        ...
        while basis.len() < expected {
            ...
            let block = Self::terminal_npo_polynomial_residual_fold_challenge_block(
                prelude,
                column_commitments,
                combined_residual_commitment,
                fold_commitments,
    ...
    fn terminal_npo_polynomial_column_combination_challenge_block(
        prelude: &TerminalProofPrelude,
        column_commitments: &[TerminalOracleCommitment],
        counter: u64,
    ) -> [u64; 5] {
        let mut sponge = TerminalDigestSponge::new();
        sponge.absorb_str("nock-terminal-npo-polynomial-column-combination-challenge-v1");
        sponge.absorb_digest(&prelude.challenge_digest.0);
        Self::absorb_terminal_parameters(&mut sponge, prelude.parameters);
        Self::absorb_relation_profile(&mut sponge, &prelude.relation_profile);
        sponge.absorb_digest(&prelude.public_values_digest.0);
        sponge.absorb_u64(column_commitments.len() as u64);
    ...
    fn terminal_npo_polynomial_combined_fold_challenge_block(
        prelude: &TerminalProofPrelude,
        column_commitments: &[TerminalOracleCommitment],
        combined_commitment: &TerminalOracleCommitment,
        fold_commitments: &[TerminalOracleCommitment],
        ...
        let mut sponge = TerminalDigestSponge::new();
        sponge.absorb_str("nock-terminal-npo-polynomial-combined-fold-challenge-v1");
        sponge.absorb_digest(&prelude.challenge_digest.0);
        Self::absorb_terminal_parameters(&mut sponge, prelude.parameters);
        Self::absorb_relation_profile(&mut sponge, &prelude.relation_profile);
        sponge.absorb_digest(&prelude.public_values_digest.0);
    ...
    fn terminal_npo_polynomial_combined_fold_query_block(
        prelude: &TerminalProofPrelude,
        column_commitments: &[TerminalOracleCommitment],
        combined_commitment: &TerminalOracleCommitment,
        fold_commitments: &[TerminalOracleCommitment],
        ...
        let mut sponge = TerminalDigestSponge::new();
        sponge.absorb_str("nock-terminal-npo-polynomial-combined-fold-query-v1");
        sponge.absorb_digest(&prelude.challenge_digest.0);
        Self::absorb_terminal_parameters(&mut sponge, prelude.parameters);
        Self::absorb_relation_profile(&mut sponge, &prelude.relation_profile);
        sponge.absorb_digest(&prelude.public_values_digest.0);
    ...
    fn terminal_npo_polynomial_residual_combination_challenge_block(
        prelude: &TerminalProofPrelude,
        column_commitments: &[TerminalOracleCommitment],
        counter: u64,
    ) -> [u64; 5] {
        let mut sponge = TerminalDigestSponge::new();
        sponge.absorb_str("nock-terminal-npo-polynomial-residual-combination-challenge-v1");
        sponge.absorb_digest(&prelude.challenge_digest.0);
        Self::absorb_terminal_parameters(&mut sponge, prelude.parameters);
        Self::absorb_relation_profile(&mut sponge, &prelude.relation_profile);
        sponge.absorb_digest(&prelude.public_values_digest.0);
    ...
    fn terminal_npo_polynomial_residual_fold_challenge_block(
        prelude: &TerminalProofPrelude,
        column_commitments: &[TerminalOracleCommitment],
        combined_residual_commitment: &TerminalOracleCommitment,
        fold_commitments: &[TerminalOracleCommitment],
        ...
        let mut sponge = TerminalDigestSponge::new();
        sponge.absorb_str("nock-terminal-npo-polynomial-residual-fold-challenge-v1");
        sponge.absorb_digest(&prelude.challenge_digest.0);
        Self::absorb_terminal_parameters(&mut sponge, prelude.parameters);
        Self::absorb_relation_profile(&mut sponge, &prelude.relation_profile);
        sponge.absorb_digest(&prelude.public_values_digest.0);
        ...
        Self::absorb_terminal_oracle_commitment(&mut sponge, combined_residual_commitment);
        sponge.absorb_u64(fold_commitments.len() as u64);
        for commitment in fold_commitments {
            Self::absorb_terminal_oracle_commitment(&mut sponge, commitment);
        }
    ...
    fn terminal_npo_polynomial_residual_fold_query_block(
        prelude: &TerminalProofPrelude,
        column_commitments: &[TerminalOracleCommitment],
        combined_residual_commitment: &TerminalOracleCommitment,
        fold_commitments: &[TerminalOracleCommitment],
        ...
        let mut sponge = TerminalDigestSponge::new();
        sponge.absorb_str("nock-terminal-npo-polynomial-residual-fold-query-v1");
        sponge.absorb_digest(&prelude.challenge_digest.0);
        Self::absorb_terminal_parameters(&mut sponge, prelude.parameters);
        Self::absorb_relation_profile(&mut sponge, &prelude.relation_profile);
        sponge.absorb_digest(&prelude.public_values_digest.0);
...
mod tests {
    ...
    fn goldilocks_npo_polynomial_columns_match_table_and_residual_oracle() {
        ...
        let derived_residuals = compiler
            ...
            .expect("NPO polynomial column predicate must evaluate");
        ...
        let output_column = tampered_columns
            .labels
            .iter()
            .position(|label| label == "output_value_0")
            .expect("output column must exist");
        tampered_columns.columns[output_column][0] += Goldilocks::ONE;
        let err = compiler
            .terminal_npo_polynomial_column_residual_values_goldilocks(&vk, &tampered_columns)
            .expect_err("tampered output column must change derived residuals");
        assert!(matches!(
            err,
        ...
        let mut tampered_columns = columns.clone();
        let mmcs_column = tampered_columns
            .labels
            .iter()
            .position(|label| label == "mmcs_bit")
            .expect("MMCS-bit column must exist");
        tampered_columns.columns[mmcs_column][0] = Goldilocks::from_u64(2);
        let err = compiler
            .terminal_npo_polynomial_column_residual_values_goldilocks(&vk, &tampered_columns)
            .expect_err("tampered MMCS-bit column must change derived residuals");
        assert!(matches!(
            err,
            NativeTerminalVerifyError::TerminalNpoPolynomialResidualMismatch { npo_index: 0, .. }
        ));
    ...
    fn goldilocks_d2_npo_polynomial_columns_commit_through_terminal_fri() {
        ...
        let input_column = bad_present_value_columns
            .labels
            .iter()
            .position(|label| label == "input_value_0")
        ...
        let bad_present_value_proof =
            ...
            .expect("FRI-valid proof with malformed present input value must build");
        compiler
            .verify_terminal_npo_polynomial_value_padding_opening_goldilocks::<GoldilocksD2>(
                &vk,
                &public_inputs,
        ...
        let mut tampered_profile = proof;
        tampered_profile.profile.basis_columns += 1;
        let err = compiler
            .verify_terminal_npo_polynomial_fri_opening_goldilocks::<GoldilocksD2>(
                &vk,
                &public_inputs,
