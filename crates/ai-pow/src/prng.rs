...
/// Pearl's `SEED_LABEL_A` (`pearl/zk-pow/src/circuit/pearl_noise.rs:28`):
...
/// Pearl's `SEED_LABEL_B` (`pearl/zk-pow/src/circuit/pearl_noise.rs:29`):
...
/// Pearl's `get_random_hash` (`pearl/zk-pow/src/circuit/pearl_noise.rs:45-56`).
///
...
/// (`pearl/zk-pow/src/circuit/pearl_noise.rs:60-79`).
///
...
/// Pearl's `mul_hi_u32` (`pearl/zk-pow/src/circuit/pearl_noise.rs:82-84`):
...
/// (`pearl/zk-pow/src/circuit/pearl_noise.rs:89-115`).
///
