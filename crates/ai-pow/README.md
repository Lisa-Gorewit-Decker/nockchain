...
tracked in [`PEARL_COMPARISON.md`](PEARL_COMPARISON.md). Every
...
| `FLAWS.md` | The Pearl-spec audit that drove the v2 → v3 redesign |
| `PEARL_COMPARISON.md` | Divergence inventory + closure tracking |
