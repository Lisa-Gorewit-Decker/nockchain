...
> user-input blocker (`2026-05-18_PHASE_B_DESIGN.md` Risk-1 / DB-1).

## 1. Why this audit

`2026-05-13_PEARL_COMPARISON.md` reports S0–S9 byte-equality, and Phase B
...
reference functions. The honest B1 question (`2026-05-18_PHASE_B_DESIGN.md`
...
| `compute_commitment_hash` chain | L181–197 | Pearl §4.3 (D1, `2026-05-13_PEARL_COMPARISON.md`) | **identical chain** — `hash_{a,b}=blake3(·, key=job_key)`; `b_noise_seed=blake3(job_key‖hash_b)`; `a_noise_seed=blake3(b_noise_seed‖hash_a)` |
...
57 344-chunk scale, and the `2026-05-13_PEARL_COMPARISON.md` precise
...
(external, `2026-05-18_PHASE_B_DESIGN.md` §7).

## 4. Cross-references

- `2026-05-18_PHASE_B_DESIGN.md` (the plan; Risk-1 / DB-1).
- `2026-05-13_PEARL_COMPARISON.md` (D1–D6 inventory; the precise claim).
