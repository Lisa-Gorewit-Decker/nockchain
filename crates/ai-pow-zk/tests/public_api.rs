...
fn root_api_does_not_reexport_dev_verifiers() {
    ...
    let unsafe_exports = [
        "composite_verify,", "composite_verify_pow,", "composite_verify_pinned,",
        "composite_verify_pow_pinned,", "composite_verify_pinned_logup_sx,",
...
fn sx_bound_helpers_are_not_public_module_api() {
    ...
    for needle in [
        "pub fn composite_prove_pinned_logup_sx", "pub fn composite_verify_pinned_logup_sx",
