...
| **M-S5b / P-C2** — ≤65 KB terminal compression of the M-S5 cert | [`2026-05-19_M_S5B_TERMINAL_COMPRESSION_DESIGN.md`](docs/2026-05-19_M_S5B_TERMINAL_COMPRESSION_DESIGN.md) | Design + KAT-first de-risk plan landed; **S(−1) FRI soundness analysis landed 2026-05-20** ([`2026-05-20_M_S5B_SOUNDNESS_ANALYSIS.md`](docs/2026-05-20_M_S5B_SOUNDNESS_ANALYSIS.md) — every M-S5 link ≥80 unconditional). **S1 comprehensive routes audit landed 2026-05-20** ([`2026-05-20_PROOF_SIZE_REDUCTION_ROUTES_AUDIT.md`](docs/2026-05-20_PROOF_SIZE_REDUCTION_ROUTES_AUDIT.md) — 8 paths × Pearl/Plonky2 deep-dive; verdict: Path H (B+A) primary, D2 (direct Plonky2) fallback; Path B alone insufficient due to ~40 KB L2 structural floor). Next: S1.B Path-B column-by-column reduction map + S2.A Path-A KAT-first prototype. Empirical L2 = 618 KB → 9.5× over 65 KB. |
