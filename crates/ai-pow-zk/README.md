...
| **M-S5b / P-C2** — ≤65 KB terminal compression of the M-S5 cert | [`2026-05-19_M_S5B_TERMINAL_COMPRESSION_DESIGN.md`](docs/2026-05-19_M_S5B_TERMINAL_COMPRESSION_DESIGN.md) | Design + KAT-first de-risk plan landed; **S(−1) paper-grounded soundness analysis landed 2026-05-20** ([`2026-05-20_M_S5B_SOUNDNESS_ANALYSIS.md`](docs/2026-05-20_M_S5B_SOUNDNESS_ANALYSIS.md) — every M-S5 link ≥80 unconditional, γ<J(δ)−η at all layers); S1 (Path B verifier-AIR reduction map) is the next deliverable. Empirical post-recalibration L2 = ~618 KB → ~9.5× over 65 KB. |
...
| **CSA — Constraint Soundness Analysis (AIR-side of ≥80 unconditional, complements S(−1))** | [`2026-05-20_CONSTRAINT_SOUNDNESS_ANALYSIS_DESIGN.md`](docs/2026-05-20_CONSTRAINT_SOUNDNESS_ANALYSIS_DESIGN.md) + [`2026-05-20_CONSTRAINT_INVENTORY.md`](docs/2026-05-20_CONSTRAINT_INVENTORY.md) | Staged design (S0–S7) landed 2026-05-20; S0 master constraint inventory landed (~117 constraint families across 27 AIRs/components, ~190 existing tamper tests catalogued, ~5 GAP-G3 items identified, 4 GAP-G2 rename-only items). Next: S1 per-constraint Schwartz–Zippel + LogUp soundness derivation table. |
