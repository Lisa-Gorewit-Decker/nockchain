...
test-pma-paging-kernel:
	NOCKCHAIN_PMA_PAGING_SKIP_MINING=1 NOCKCHAIN_PMA_PAGING_BLOCKS=2000 NOCKCHAIN_PMA_PAGING_BYTES=1073741824 NOCKCHAIN_PMA_PAGING_OUTPUTS=8 cargo test --release --test pma_paging_kernel -- --ignored
