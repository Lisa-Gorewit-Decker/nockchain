...
- full `ai-pow-zk` composite-verifier integrated-LogUp polynomial NPO
  ...
  **7.600s** prelude construction, and **14.435s** primitive proving before the
  ...
  3-lane LogUp grouping change. These are sound checkpoints, not appendable
  production proof bodies; the production route still has to fuse packed AIR,
  packed LogUp, projection, and the selected-value bridge under a smaller
  algebraic transcript/opening shape.
