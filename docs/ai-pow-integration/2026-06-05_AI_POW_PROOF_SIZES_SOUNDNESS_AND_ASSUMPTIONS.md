...
- full `ai-pow-zk` composite-verifier integrated-LogUp polynomial NPO
  ...
  **7.600s** prelude construction, and **14.435s** primitive proving before the
  ...
  500-column packed trace. These are sound checkpoints, not appendable
  production proof bodies; the production route still has to fuse packed AIR,
  packed LogUp, and direct selected-value-to-packed-trace binding under a
  smaller algebraic transcript/opening shape that shares the packed trace
  opening.
