...
- full `ai-pow-zk` composite-verifier integrated-LogUp polynomial NPO
  ...
  **25,912 bytes** of FRI opened values plus **4,082 bytes** of non-FRI zeta
  ...
  new table-domain overhead. The production route therefore has to remove the
  packed-support theorem's FRI input-batch, Merkle, accumulator, and/or
  commit-round shape itself, then fold the resulting leaner Tip5 binding into
  the merged value-bridge theorem. Additional prelude commitment caching,
