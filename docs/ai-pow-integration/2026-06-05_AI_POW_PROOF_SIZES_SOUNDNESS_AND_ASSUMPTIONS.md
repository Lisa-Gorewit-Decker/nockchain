...
2. The compact final-layer batch-STARK L2 path is the committed primary
   ...
   Hoon wire path, or a production-pinned expected verifier-key/setup digest.
