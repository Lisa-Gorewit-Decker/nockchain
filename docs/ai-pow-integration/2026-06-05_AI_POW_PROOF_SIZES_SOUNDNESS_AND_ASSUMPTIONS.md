...
- full `ai-pow-zk` composite-verifier integrated-LogUp polynomial NPO
  ...
  **36.590s** proving to **198,287 bytes** / **33.277s** proving, with compact
  ...
  checkpoints, not appendable production proof bodies; the production route
  now has to reduce the remaining full-trace/accumulator opening payload and
  fold a leaner packed Tip5 binding into the merged value-bridge theorem.
